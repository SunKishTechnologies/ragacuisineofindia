...
if(isset($_POST['sendfax']))
{
	...
	$fromaddress = "suneesha@sunkish.com";
	$fromname = "Raga Cuisine of India";
	$fname = "RAAGA FIRST NAME";
	$subject = "New Offer from Raga";
	$file_path = "/home/ragaaen8/public_html/admin/Ragafeedback.doc";
	$attachments[] = $file_path;
	$body = "Fax sent";
	$subject = "Fax";
	Send_Mail($fax_address, $body, $subject, $fromaddress, $fromname, $attachments=true, $fname);
}
?>
